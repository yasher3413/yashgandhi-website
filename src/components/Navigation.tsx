...
const Navigation = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ['home', 'about', 'experience', 'projects', 'wellness', 'book', 'blog', 'listens', 'contact'];
      ...
      <nav className="fixed top-4 right-4 z-40">
        ...
        >
          <ul className="flex flex-col md:flex-row gap-2">
            {['home', 'about', 'experience', 'projects', 'wellness', 'book', 'blog', 'listens', 'contact'].map((section) => (
              <li key={section}>
                <motion.button
